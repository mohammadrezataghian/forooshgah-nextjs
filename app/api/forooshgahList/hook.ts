...
const ForooshgahListURL = `${process.env.NEXT_PUBLIC_API_BASE_URL}/pub/ForooshgahList`

// --- fetcher function ---
const fetcher = async () => {
  try {
    const res = await axios.get(ForooshgahListURL)
    ...
    throw new Error(err.message || 'An unknown error occurred in ForooshgahList')
  }
}
