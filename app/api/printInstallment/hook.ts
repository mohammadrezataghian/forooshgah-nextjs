...
const usePrintInstallment = (userToken: any) => {

const GetPrintAghsatDetail = `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/GetPrintAghsatDetail`
  ...
  const getPrint = async (data: any) => {
    ...
    try {
      ...
      setPrintDocResponse(res);
        ...
        setPrintDocError(
        err.message || "An unknown error occurred in GetPrintAghsatDetail"
      );
...
export default usePrintInstallment;
