...
const LoadingSkeleton = () => {
  return (
    <>
    <div className="grid 2xl:grid-cols-4 xl:grid-cols-3 sm:grid-cols-2 2xl:gap-10 xl:gap-9 lg-gap-5 gap-10 justify-center items-center grid-rows-2 sm:grid-rows-1 lg:grid-rows-2 ">
        <Skeleton
        sx={{ bgcolor: '#bdbdbd' }} 
