...
import UserPassDialog from './_components/UsernameDialog';
...
// timer
    ...
    // send mobile number
const { error, getCheckLoginStaff,loading,checkLoginStaff } = useGetCheckLoginStaff()
...
const router = useRouter()
  ...
  async function handleSubmitVerification() {
      ...
      const res = await getSubmitLoginStaff(param)
  ...
  return (
    <>
        ...
        <div className='w-full h-screen flex justify-center items-center bg-white'>
            <div className='w-full lg:w-[400px] lg:h-auto p-5 lg:border lg:border-gray-300 flex flex-col gap-5 lg:rounded-xl relative'>
                <div className='w-full h-auto flex justify-center'>   
                    <Image src={Logo} alt=""  className='w-24'/>
                </div>
                <div className='flex w-full'>
                    <h1 className='text-lg'>ورود کارکنان</h1>
                </div>
